...
const Projects = () => {
  ...
  return (
    <section className="c-space my-20 mx-auto max-w-screen-xl" id='work'>
      <p className="head-text">My Work</p>

      <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
        <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-lg shadow-black-200">
